    ...
    base64(){
        ...
        return {
            ...
            decode : function( string ){
                ...
                let i = 0;
                do {
                    const b1 = $that.characters.indexOf( string.charAt(i++) );
                    const b2 = $that.characters.indexOf( string.charAt(i++) );
                    const b3 = $that.characters.indexOf( string.charAt(i++) );
                    const b4 = $that.characters.indexOf( string.charAt(i++) );
